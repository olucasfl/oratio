...
export const SAINTS_OF_THE_DAY: SaintOfDayEntry[] = [
  ...
  { dia:19, mes:11, nome:"São Roque González e companheiros, mártires", match:["roque gonzalez"], bioId:"sao-roque-gonzalez" },
  { dia:20, mes:11, nome:"São Félix de Valois, religioso", match:["felix de valois"], bioId:"sao-felix-valois" },
  { dia:21, mes:11, nome:"Apresentação da Virgem Maria", match:["apresentacao da virgem maria","apresentacao de nossa senhora ao templo"], bioId:"apresentacao-maria" },
  { dia:22, mes:11, nome:"Santa Cecília, virgem e mártir, padroeira dos músicos", match:["cecilia, virgem"], bioId:"santa-cecilia" },
  { dia:23, mes:11, nome:"São Clemente I, Papa e mártir", match:["clemente i"], bioId:"sao-clemente-i", opcional:true },
  { dia:24, mes:11, nome:"Santo André Dung-Lac e companheiros, mártires", match:["andre dung lac"], bioId:"santo-andre-dung-lac" },
  { dia:25, mes:11, nome:"Santa Catarina de Alexandria, virgem e mártir", match:["catarina de alexandria"], bioId:"santa-catarina-alexandria", opcional:true },
  ...
  { dia:4, mes:12, nome:"São João Damasceno, presbítero e doutor da Igreja", match:["joao damasceno"], bioId:"sao-joao-damasceno", opcional:true },
  { dia:5, mes:12, nome:"São Sabas, abade", match:["sabas, abade"], bioId:"sao-sabas", opcional:true },
  { dia:6, mes:12, nome:"São Nicolau de Mira, bispo", match:["nicolau de mira","nicolau de bari"], bioId:"sao-nicolau", opcional:true },
  { dia:7, mes:12, nome:"Santo Ambrósio, bispo e doutor da Igreja", match:["ambrosio, bispo"], bioId:"santo-ambrosio" },
  { dia:8, mes:12, nome:"Imaculada Conceição da Virgem Maria", match:["imaculada conceicao"], bioId:"imaculada-conceicao" },
  { dia:9, mes:12, nome:"São Juan Diego Cuauhtlatoatzin", match:["juan diego"], bioId:"sao-juan-diego", opcional:true },
  { dia:10, mes:12, nome:"Nossa Senhora de Loreto", match:["nossa senhora de loreto","loreto"], bioId:"nossa-senhora-loreto", opcional:true },
  { dia:11, mes:12, nome:"São Dâmaso I, Papa", match:["damaso i"], bioId:"sao-damaso-i", opcional:true },
  { dia:12, mes:12, nome:"Nossa Senhora de Guadalupe", match:["nossa senhora de guadalupe"], bioId:"nossa-senhora-guadalupe" },
  { dia:13, mes:12, nome:"Santa Luzia, virgem e mártir", match:["luzia, virgem"], bioId:"santa-luzia" },
