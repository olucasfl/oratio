...
export const SAINTS_OF_THE_DAY: SaintOfDayEntry[] = [
  ...
  { dia:27, mes:7, nome:"São Pantaleão, mártir", match:["pantaleao"], bioId:"sao-pantaleao" },
  { dia:28, mes:7, nome:"São Celestino I, Papa", match:["celestino i","celestino, papa"], bioId:"sao-celestino-i" },
