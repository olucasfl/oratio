...
export const SAINTS_OF_THE_DAY: SaintOfDayEntry[] = [
  ...
  { dia:21, mes:7, nome:"São Lourenço de Brindisi, presbítero e doutor da Igreja", match:["lourenco de brindisi"] },
  { dia:22, mes:7, nome:"Santa Maria Madalena, discípula do Senhor", match:["maria madalena, discipula"] },
  { dia:23, mes:7, nome:"Santa Brígida da Suécia, religiosa", match:["brigida da suecia","santa brigida"] },
  { dia:24, mes:7, nome:"Santa Cristina, virgem e mártir", match:["cristina, virgem"] },
  { dia:25, mes:7, nome:"São Tiago Maior, Apóstolo", match:["tiago maior"] },
  { dia:26, mes:7, nome:"São Joaquim e Santa Ana, pais de Nossa Senhora", match:["joaquim e santa ana","joaquim e ana"] },
  { dia:27, mes:7, nome:"São Pantaleão, mártir", match:["pantaleao"] },
  { dia:28, mes:7, nome:"São Celestino I, Papa", match:["celestino i","celestino, papa"] },
  { dia:29, mes:7, nome:"Santa Marta, Santa Maria e São Lázaro de Betânia", match:["marta, maria e lazaro","santa marta"] },
  { dia:30, mes:7, nome:"São Pedro Crisólogo, bispo e doutor da Igreja", match:["pedro crisologo"] },
  { dia:31, mes:7, nome:"Santo Inácio de Loyola, presbítero e fundador da Companhia de Jesus", match:["inacio de loyola"] },

  // ---------- AGOSTO ----------
  { dia:1, mes:8, nome:"Santo Afonso Maria de Ligório, bispo e doutor da Igreja", match:["afonso maria de ligorio","afonso de ligorio"] },
  { dia:2, mes:8, nome:"São Pedro Julião Eymard, presbítero", match:["pedro juliao eymard"] },
  { dia:3, mes:8, nome:"Santa Lídia, discípula de São Paulo", match:["lidia, discipula"] },
  { dia:4, mes:8, nome:"São João Maria Vianney, presbítero (Cura d'Ars)", match:["joao maria vianney","cura d ars"] },
  { dia:5, mes:8, nome:"Dedicação da Basílica de Santa Maria Maior", match:["dedicacao da basilica de santa maria maior"] },
  { dia:6, mes:8, nome:"Transfiguração do Senhor", match:["transfiguracao do senhor"], bioId:"transfiguracao" },
  { dia:7, mes:8, nome:"São Sisto II, Papa, e companheiros, mártires", match:["sisto ii"] },
  { dia:8, mes:8, nome:"São Domingos de Gusmão, presbítero", match:["domingos de gusmao"] },
  { dia:9, mes:8, nome:"Santa Teresa Benedita da Cruz (Edith Stein), virgem e mártir", match:["teresa benedita da cruz","edith stein"] },
  { dia:10, mes:8, nome:"São Lourenço, diácono e mártir", match:["lourenco, diacono"] },
  { dia:11, mes:8, nome:"Santa Clara de Assis, virgem", match:["clara de assis","santa clara"] },
  { dia:12, mes:8, nome:"Santa Joana Francisca de Chantal", match:["joana francisca de chantal"] },
  { dia:13, mes:8, nome:"Santa Dulce dos Pobres", match:["dulce dos pobres","dulce lopes pontes","santa dulce"], bioId:"santa-dulce" },
  { dia:14, mes:8, nome:"São Maximiliano Maria Kolbe, presbítero e mártir", match:["maximiliano maria kolbe","maximiliano kolbe"] },
  { dia:15, mes:8, nome:"Assunção da Virgem Maria", match:["assuncao"], bioId:"assuncao" },
  { dia:16, mes:8, nome:"Santo Estêvão, Rei da Hungria", match:["estevao, rei da hungria"] },
  { dia:17, mes:8, nome:"São Jacinto", match:["sao jacinto"] },
  { dia:18, mes:8, nome:"Santa Helena, imperatriz", match:["helena, imperatriz"] },
  { dia:19, mes:8, nome:"São João Eudes, presbítero", match:["joao eudes"] },
  { dia:20, mes:8, nome:"São Bernardo de Claraval, abade e doutor da Igreja", match:["bernardo de claraval","bernardo claraval","bernardo, abade"] },
  { dia:21, mes:8, nome:"São Pio X, Papa", match:["pio x"] },
  { dia:22, mes:8, nome:"Santa Maria Rainha", match:["maria rainha","nossa senhora rainha"] },
  { dia:23, mes:8, nome:"Santa Rosa de Lima, virgem, padroeira da América Latina", match:["rosa de lima"] },
  { dia:24, mes:8, nome:"São Bartolomeu, Apóstolo", match:["bartolomeu, apostolo"] },
  { dia:25, mes:8, nome:"São Luís, Rei da França", match:["luis, rei da franca"] },
  { dia:26, mes:8, nome:"São Zeferino, Papa e mártir", match:["zeferino, papa"] },
  { dia:27, mes:8, nome:"Santa Mônica", match:["monica, mae de santo agostinho","santa monica"] },
  { dia:28, mes:8, nome:"Santo Agostinho, bispo e doutor da Igreja", match:["agostinho, bispo"] },
  { dia:29, mes:8, nome:"Martírio de São João Batista", match:["martirio de sao joao batista"] },
  { dia:30, mes:8, nome:"Santos Félix e Adauto, mártires", match:["felix e adauto"] },
  ...
  { dia:5, mes:9, nome:"Santa Teresa de Calcutá", match:["teresa de calcuta"] },
  { dia:6, mes:9, nome:"São Liberato de Loro", match:["liberato de loro"] },
  { dia:7, mes:9, nome:"Santa Regina, virgem e mártir", match:["regina, virgem"] },
  { dia:8, mes:9, nome:"Natividade da Virgem Maria", match:["natividade de maria","natividade da virgem maria","natividade da"] },
  { dia:9, mes:9, nome:"São Pedro Claver, presbítero", match:["pedro claver"] },
  { dia:10, mes:9, nome:"São Nicolau de Tolentino", match:["nicolau de tolentino"] },
  { dia:11, mes:9, nome:"São João Gabriel Perboyre", match:["joao gabriel perboyre"] },
  { dia:12, mes:9, nome:"Santíssimo Nome de Maria", match:["santissimo nome de maria"] },
  { dia:13, mes:9, nome:"São João Crisóstomo, bispo e doutor da Igreja", match:["joao crisostomo"] },
  { dia:14, mes:9, nome:"Exaltação da Santa Cruz", match:["exaltacao da santa cruz"] },
  { dia:15, mes:9, nome:"Nossa Senhora das Dores", match:["nossa senhora das dores","das dores"] },
  { dia:16, mes:9, nome:"São Cornélio, Papa, e São Cipriano, bispo, mártires", match:["cornelio, papa","cipriano, bispo"] },
  { dia:17, mes:9, nome:"São Roberto Belarmino, bispo e doutor da Igreja", match:["roberto belarmino"] },
  { dia:18, mes:9, nome:"São José de Cupertino", match:["jose de cupertino"] },
  { dia:19, mes:9, nome:"São Januário, bispo e mártir", match:["januario, bispo"] },
  { dia:20, mes:9, nome:"Santo André Kim Taegon e companheiros, mártires", match:["andre kim taegon","andre kim tae gon","andre kim"] },
  { dia:21, mes:9, nome:"São Mateus, Apóstolo e Evangelista", match:["mateus, apostolo e evangelista"] },
  { dia:22, mes:9, nome:"São Maurício e companheiros, mártires", match:["mauricio e companheiros"] },
  { dia:23, mes:9, nome:"São Pio de Pietrelcina (Padre Pio)", match:["pio de pietrelcina","padre pio"] },
  { dia:24, mes:9, nome:"Nossa Senhora das Mercês", match:["nossa senhora das merces"] },
  { dia:25, mes:9, nome:"São Cléofas", match:["cleofas"] },
  { dia:26, mes:9, nome:"Santos Cosme e Damião, mártires", match:["cosme e damiao"] },
  { dia:27, mes:9, nome:"São Vicente de Paulo, presbítero", match:["vicente de paulo"] },
  { dia:28, mes:9, nome:"São Venceslau, mártir", match:["venceslau"] },
  { dia:29, mes:9, nome:"Santos Miguel, Gabriel e Rafael, Arcanjos", match:["miguel, gabriel e rafael","arcanjos"] },
  { dia:30, mes:9, nome:"São Jerônimo, presbítero e doutor da Igreja", match:["jeronimo, presbitero"] },

  // ---------- OUTUBRO ----------
  { dia:1, mes:10, nome:"Santa Teresinha do Menino Jesus, virgem e doutora da Igreja", match:["teresinha do menino jesus","teresa do menino jesus"] },
  { dia:2, mes:10, nome:"Santos Anjos da Guarda", match:["santos anjos da guarda"] },
  { dia:3, mes:10, nome:"Protomártires do Brasil", match:["protomartires do brasil"] },
  { dia:4, mes:10, nome:"São Francisco de Assis", match:["francisco de assis"] },
  { dia:5, mes:10, nome:"Santa Faustina Kowalska, apóstola da Divina Misericórdia", match:["faustina kowalska"] },
  { dia:6, mes:10, nome:"São Bruno, presbítero", match:["bruno, presbitero"] },
  { dia:7, mes:10, nome:"Nossa Senhora do Rosário", match:["nossa senhora do rosario","do rosario"] },
  { dia:8, mes:10, nome:"Santa Pelágia, virgem e mártir", match:["pelagia, virgem"] },
  { dia:9, mes:10, nome:"São João Leonardo, presbítero", match:["joao leonardo"] },
  { dia:10, mes:10, nome:"São Daniel Comboni, bispo", match:["daniel comboni"] },
  { dia:11, mes:10, nome:"São João XXIII, Papa", match:["joao xxiii"] },
  { dia:12, mes:10, nome:"Nossa Senhora Aparecida, Padroeira do Brasil", match:["aparecida"], bioId:"nossa-senhora-aparecida" },
  { dia:13, mes:10, nome:"Beata Alexandrina Maria da Costa, virgem", match:["alexandrina maria da costa"] },
  { dia:14, mes:10, nome:"São Calisto I, Papa e mártir", match:["calisto i"] },
  { dia:15, mes:10, nome:"Santa Teresa de Jesus (Teresa d'Ávila), virgem e doutora da Igreja", match:["teresa de jesus","teresa d avila","teresa d'avila"] },
  { dia:16, mes:10, nome:"Santa Margarida Maria Alacoque, virgem", match:["margarida maria alacoque"] },
  { dia:17, mes:10, nome:"Santo Inácio de Antioquia, bispo e mártir", match:["inacio de antioquia"] },
  { dia:18, mes:10, nome:"São Lucas, Evangelista", match:["lucas, evangelista"] },
  { dia:19, mes:10, nome:"São Paulo da Cruz, presbítero", match:["paulo da cruz"] },
  { dia:20, mes:10, nome:"Santa Maria Bertila Boscardin, virgem", match:["maria bertila boscardin"] },
  { dia:21, mes:10, nome:"Santa Úrsula e companheiras, mártires", match:["ursula e companheiras"] },
  { dia:22, mes:10, nome:"São João Paulo II, Papa", match:["joao paulo ii"] },
  { dia:23, mes:10, nome:"São João de Capistrano, presbítero", match:["joao de capistrano"] },
  ...
  { dia:7, mes:11, nome:"São Wilibrordo, bispo", match:["wilibrordo","vilibrordo"] },
  { dia:8, mes:11, nome:"São Deodato", match:["deodato"] },
  { dia:9, mes:11, nome:"Dedicação da Basílica de Latrão", match:["dedicacao da basilica de sao joao de latrao","basilica de latrao","basilica do latrao","latrao"] },
  { dia:10, mes:11, nome:"São Leão Magno, Papa e doutor da Igreja", match:["leao magno"] },
  { dia:11, mes:11, nome:"São Martinho de Tours, bispo", match:["martinho, bispo","martinho de tours"] },
  { dia:12, mes:11, nome:"São Josafá, bispo e mártir", match:["josafa"] },
  { dia:13, mes:11, nome:"Santo Estanislau Kostka", match:["estanislau kostka"] },
  { dia:14, mes:11, nome:"São José Pignatelli", match:["jose pignatelli"] },
  { dia:15, mes:11, nome:"Santo Alberto Magno, bispo e doutor da Igreja", match:["alberto magno"] },
  { dia:16, mes:11, nome:"Santa Margarida da Escócia", match:["margarida da escocia"] },
  { dia:17, mes:11, nome:"Santa Isabel da Hungria, religiosa", match:["isabel da hungria"] },
  { dia:18, mes:11, nome:"Dedicação das Basílicas de São Pedro e São Paulo", match:["dedicacao das basilicas de sao pedro e sao paulo"] },
